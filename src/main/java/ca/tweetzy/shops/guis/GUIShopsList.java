...
public class GUIShopsList extends Gui {
    ...
    private void draw() {
        ...
        for (Shop shop : data) {
            setButton(slot++, ConfigurationItemHelper.build(ShopAPI.getInstance().deserializeItem(shop.getDisplayIcon()), Settings.GUI_SHOP_LIST_ITEM_NAME.getString(), Settings.GUI_SHOP_LIST_ITEM_LORE.getStringList(), new HashMap<String, Object>() {{
